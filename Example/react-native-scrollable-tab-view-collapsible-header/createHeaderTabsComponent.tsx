...
type ZTabViewProps = Omit<ScrollableTabViewProperties, 'ref'> &
  CollapsibleHeaderProps;
type ForwardTabViewProps = ZTabViewProps & {
  forwardedRef: React.Ref<ScrollableTabView>;
  Component: typeof ScrollableTabView;
};

export default function createHeaderTabsComponent(
  Component: typeof ScrollableTabView,
  config?: {},
): React.ForwardRefExoticComponent<
  React.PropsWithoutRef<ZTabViewProps> & React.RefAttributes<ScrollableTabView>
> {
...
const CollapsibleHeaderTabView: React.FC<ForwardTabViewProps> = (
  props: ForwardTabViewProps,
) => {
  ...
  const renderTabView = (mProps: {renderTabBarContainer: any}) => {
